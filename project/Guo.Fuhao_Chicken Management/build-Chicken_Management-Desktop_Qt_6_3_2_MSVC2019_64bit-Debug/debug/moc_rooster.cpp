...
#include <memory>
#include "../../Chicken_Management/src/rooster.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Rooster_t::offsetsAndSizes) + ofs), len 
static const qt_meta_stringdata_Rooster_t qt_meta_stringdata_Rooster = {
    {
        QT_MOC_LITERAL(0, 7)   // "Rooster"
    },
    "Rooster"
};
...
const QMetaObject Rooster::staticMetaObject = { {
    ...
    qt_meta_stringdata_Rooster.offsetsAndSizes,
    qt_meta_data_Rooster,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Rooster_t
, QtPrivate::TypeAndForceComplete<Rooster, std::true_type>
...
void *Rooster::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Rooster.stringdata0))
